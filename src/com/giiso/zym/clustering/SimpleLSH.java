...
import com.giiso.zym.utils.MathUtils;

public class SimpleLSH {

	private int dimension; //维度大小，例如对于sift特征来说就是128
	...
	public SimpleLSH(int dimension, int max, int hashCount, int bitCount) {
	    this.dimension = dimension;
	    this.max = max;
	    this.hashCount = hashCount;
	    this.bitCount = bitCount;
	    this.size = this.dimension * this.max;
